...
public class UserProfileRequest {
	...
	public static class Builder //Builder class or Inner class or Builder design pattern
	
	{
		...
		{
			UserProfileRequest profileRequest = new UserProfileRequest(firstName, lastName, email, mobileNumber);
